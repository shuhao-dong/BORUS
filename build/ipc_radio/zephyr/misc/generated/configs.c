...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_PAWR_ADV, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_PAWR_ADV_COUNT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_PERIODIC_ADV_RSP_TX_BUFFER_COUNT, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_PERIODIC_ADV_RSP_TX_MAX_DATA_SIZE, 73);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_PERIODIC_ADV_RSP_RX_BUFFER_COUNT, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PER_ADV_RSP, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_ADV_PERIODIC_RSP, 1);
