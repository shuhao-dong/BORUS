...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DEVICE_VID, 0x0001);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_ACCEL_CTR_AES_128, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_ACCEL_CTR_AES_192, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_ACCEL_CTR_AES_256, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_ACCEL_GENERATE_RANDOM, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_NEED_CC3XX_CTR_AES, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PM_PARTITION_SIZE_TFM, 0xFE00);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DISK_LOG_LEVEL_DBG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DISK_LOG_LEVEL, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DFU_CLASS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DEVICE_DFU_PID, 0xFFFF);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DFU_WILL_DETACH, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DFU_DETACH_TIMEOUT, 100);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DFU_DEFAULT_POLLTIMEOUT, 8);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DFU_ENABLE_UPLOAD, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DFU_REBOOT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DFU_PERMANENT_DOWNLOAD, 1);
